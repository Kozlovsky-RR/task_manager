            ...
            if "distutils" in sections:
                ...
                if _servers == []:
                    ...
                    for server in _servers:
                        ...
                        # optional params
                        for key, default in (
                            ("test_repository", self.DEFAULT_REPOSITORY),
                        ...
                        # work around people having "test_repository" for the "pypi"
                        ...
                        if server == "pypi" and repository in (
                            ...
                            result["test_repository"] = self.DEFAULT_REPOSITORY
                        elif (
                            result["server"] != repository
                            and result["test_repository"] != repository
                        ):
                            result = {}
            elif "server-login" in sections:
                # old format
                server = "server-login"
                if config.has_option(server, "test_repository"):
                    repository = config.get(server, "test_repository")
                else:
