...
class Android(PlatformDirsABC):
    ...
    Makes use of the `appname <platformdirs.test_api.PlatformDirsABC.appname>`, `version
    <platformdirs.test_api.PlatformDirsABC.version>`, `ensure_exists <platformdirs.test_api.PlatformDirsABC.ensure_exists>`.
